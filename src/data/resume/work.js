...
const work = [
  {
    ...
    highlights: [
      'Developed the data analysis, feature engineering, and model training pipelines using Python, XGBoost, and LGBM, processed over 1M customers data, and improved its accuracy by 14%.',
      'Implemented reusable pipelines for mortgage price optimization and feature engineering.',
      ...
      'Delivered advanced statistical analysis to deepen business understanding and led a team tech talk.',
    ],
  },
  {
    ...
    highlights: [
      ...
      'Implemented a RESTful API that computes climate statistics using Java, Python, and R.',
      ...
      'Set up and maintained a web server and its connection to a MySQL database.',
    ],
  },
];
